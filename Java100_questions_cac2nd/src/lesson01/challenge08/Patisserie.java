...
public class Patisserie {
	...
	public static void main(String[] args) throws IOException {
		...
		double citronsales = citronBuyCount * 250;
		double chocolatsales = chocolatBuyCount * 280;
		double pistachesales = pistacheBuyCount * 320;

		System.out.println("シトロン    \\" + (int) citronsales + "・・・" + (int) ((citronsales / totalPrice) * 100) + "%");
		System.out
				.println("ショコラ    \\" + (int) chocolatsales + "・・・" + (int) ((chocolatsales / totalPrice) * 100) + "%");
		System.out.println(
				"ピスターシュ   \\" + (int) pistachesales + "・・・" + (int) ((pistachesales / totalPrice) * 100) + "%");
